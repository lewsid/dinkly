...
{ 
  ...
  $yaml_file        = $_SERVER['APPLICATION_ROOT'] . '/classes/thirdparty/Yaml/' . $class_name . '.php';
  $exception_file   = $_SERVER['APPLICATION_ROOT'] . '/classes/thirdparty/Yaml/Exception/' . $class_name . '.php';
